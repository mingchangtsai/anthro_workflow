...
brand_header <- function() {
  fluidRow(
    column(3, tags$img(src = "CSIP.jpg", height = "80px", style = "padding:10px;")),
    column(6, div(style="text-align:center; padding-top:10px;",
                  span(style="font-weight:800;color:#b91c1c;font-size:36px;letter-spacing:0.3px;",
                       "CSI Pacific Anthropometry"))),
    column(3, div(style = "text-align:right;", tags$img(src = "CCBC.jpg", height = "80px", style = "padding:10px;")))
  )
}
  ...
  navbarPage(
    ...
    tabPanel(
      ...
      fluidPage(
        ...
        fluidRow(
          column(4, actionButton("report_reload", "Reload list", class = "btn-outline-secondary")),
          column(4, actionButton("report_select_all", "Select all", class = "btn-outline-secondary")),
          column(4, actionButton("report_select_none", "Select none", class = "btn-outline-secondary"))
        ),
        br(),
        DTOutput("report_tbl"),
        tags$script(HTML("
        ...
        br(),
        fluidRow(
          column(4, actionButton("report_print", "Print selected (PDF)", class = "btn-primary", width = "100%")),
...
server <- function(input, output, session) {
  ...
  # Download selected sessions as ONE CSV (with progress + robust data pull)
